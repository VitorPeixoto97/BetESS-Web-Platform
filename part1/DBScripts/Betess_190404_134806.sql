...
-- User_Bet [rel1]
alter table `user_2`  add column  `bet_result`  integer;
alter table `user_2`   add index fk_user_2_bet (`bet_result`), add constraint fk_user_2_bet foreign key (`bet_result`) references `bet` (`result`);
